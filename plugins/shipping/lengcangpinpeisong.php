...
$shipping_lang = ROOT_PATH . 'languages/' . $GLOBALS['_CFG']['lang'] . '/shipping/lengcangpinpeisong.php';
...
if (isset($set_modules) && $set_modules == TRUE) {
    ...
    /* 配送方式插件的代码必须和文件名保持一致 */
    $modules[$i]['code'] = 'lengcangpinpeisong';

    $modules[$i]['version'] = '1.0.0';

    /* 配送方式的描述 */
    $modules[$i]['desc'] = 'lengcangpinpeisong_desc';
...
class lengcangpinpeisong
{
     ...
     * @return null
     */
    function lengcangpinpeisong($cfg = array())
    {
