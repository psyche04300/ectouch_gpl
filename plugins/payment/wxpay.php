...
if (isset($set_modules) && $set_modules == TRUE) {
    ...
    /* 作者 */
    $modules[$i]['author'] = 'ECTOUCH_GPL TEAM';
    /* 网址 */
...
class wxpay
{
    ...
    function get_code($order, $payment)
    {
        ...
        if( !preg_match('/micromessenger/', $ua)){
            //die(var_dump($order['order_sn'] . 'O' . $order['log_id']));
      ...
      $notify_url=get_domain().'/mobile/notify_wap_wxpay.php';
       // file_put_contents("./wxpay.txt",$notify_url);
