...
?>
      <li><a href="<?php echo url('goods/index', array('id'=>$this->_var['goods']['goods_id']));?>" target="_blank"><img src="<?php echo $this->_var['goods']['goods_thumb']; ?>"></a>
        <dl>
          ...
          <dd class="dd-price"><b class="pull-left"><?php echo $this->_var['lang']['ws_subtotal']; ?>：<span class="ect-colory"><?php echo $this->_var['goods']['subtotal']; ?></span></b>
...
<div class="two-btn ect-padding-tb ect-padding-lr ect-margin-tb text-center"> <?php echo $this->_var['order']['handler']; ?> 
  <?php if ($this->_var['order']['invoice_no']): ?><a class="btn btn-info ect-bg-colory" style="background:#C60" type="button" href="<?php echo url('order_tracking', array('order_id'=>$this->_var['order']['order_id']));?>"><?php echo $this->_var['lang']['order_tracking']; ?></a><?php endif; ?>
</div>
...
?>
      ...
      <input type="submit" name="Submit" class="btn btn-info ect-btn-info ect-colorf ect-bg" value="<?php echo $this->_var['lang']['button_submit']; ?>" />
    </form>  
    </li>
    <?php endif; ?>
  </ul>
