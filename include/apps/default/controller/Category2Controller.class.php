...
class Category2Controller extends CommonController {
...
//        die(var_dump(model('CategoryBase')->get_top_category()));
...
//        die(var_dump(model('Index')->goods_list('new', C('page_size'))));
       ...
       // $this->assign('pager', $this->pageShow($count));
        ...
        // 商品分类
        // var_dump($this->cat_id);die; 0
        // var_dump(model('CategoryBase')->get_categories_tree($this->cat_id));die;
    ...
    public function keywords() {
        ...
        if ($keywords != '') {
             ...
             * 处理关键字查询次数
             */
            $sql = 'INSERT INTO ' . $this->model->pre . "keywords (date , searchengine,keyword ,count) VALUES ('" . local_date('Y-m-d') . "', '" . ECTouch_gpl . "', '" . addslashes(str_replace('%', '', $val)) . "', '1')";
    ...
    public function top_all() {
        ...
        if (!ECTouch_gpl::view()->is_cached('category_all.dwt', $cache_id)) {
