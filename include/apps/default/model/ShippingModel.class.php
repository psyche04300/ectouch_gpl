...
class ShippingModel extends BaseModel {
    ...
    function available_shipping_list2($region_id_list) {
        ...
        $list = $this->available_shipping_list($region_id_list);
        ...
        foreach ($list as $item) {
            ...
            if (!in_array($item['shipping_name'] , $shippingNames)) {

                array_push($shippingNames, $item['shipping_name']);
                array_push($res, $item);
            }
        }
