...
class CategoryModel extends BaseModel {
    ...
    function get_touch_cat(){

        return   $this->model->table('category as a, ' . $this->model->pre . 'touch_category as b')->where('a.cat_id=b.cat_id and a.is_show=1')->select();
    }
