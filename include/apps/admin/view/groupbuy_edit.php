      ...
      <table id="general-table" class="table table-hover ectouch_gpl-table">
        ...
        <tr>
          ...
          <td><div class="col-md-4">
              ...
              {if $info['act_banner']}
              <div class="col-md-1">
                <a href="javascript:;" class="glyphicon glyphicon-picture ectouch_gpl-fs16" style="text-decoration:none;" onClick="showImg('act_banner', '{$lang['label_banner']}')" title="View"></a>
