...
.ectouch_gpl-table {margin:0;}
.ectouch_gpl-table tr:first-child td {border-top:none;}
.ectouch_gpl-line {line-height: 1.8;}
.ectouch_gpl-mb5, .breadcrumb {margin-bottom:5px}
.ectouch_gpl-fs16 {font-size:16px}
.ectouch_gpl-fs18 {font-size:18px}
.btn-primary {background-color:#1b9ad5}
.panel-title {font-size:14px}
.pagination {margin-top:0}
.pagination .glyphicon {top:0}
.ectouch_gpl-mb{margin-bottom:5px;}
.clear{clear:both;}
.borderno{border:0;}
</style>
...
<div class="row" style="margin:0">
	<div class="pull-right ectouch_gpl-mb5"><a href="{$action_link['href']}" class="btn btn-primary">{$action_link['text']}</a></div>
</div>
{/if}
