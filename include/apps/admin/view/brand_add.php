      ...
      <table id="general-table" class="table table-hover ectouch_gpl-table">
        ...
        <tr>
          ...
          <td><div class="col-md-4">
              ...
              {if $info['brand_logo']}
              <div class="col-md-1">
                <a href="javascript:;" class="glyphicon glyphicon-picture ectouch_gpl-fs16" style="text-decoration:none;" onClick="showImg('brand_logo_layer', '{$lang['brand_logo']}')" title="View"></a>
        ...
        <tr>
          ...
          <td><div class="col-md-4">
              ...
              <div class="col-md-1">
                <a href="javascript:;" class="glyphicon glyphicon-picture ectouch_gpl-fs16" style="text-decoration:none;" onClick="showImg('brand_banner_layer', '{$lang['brand_banner']}')" title="View"></a>
